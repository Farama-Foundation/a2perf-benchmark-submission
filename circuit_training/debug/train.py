...
#
#     run_command("bash train.sh", "train_output")
#
#     root_dir = os.getenv("ROOT_DIR")
#     if root_dir is None:
#         raise ValueError("Missing environment variable: ROOT_DIR")
...
#
#     # Start reverb server
#     reverb_command = f"""python3.9 -m learning.ppo_reverb_server \
# --root_dir={root_dir} \
...
#
#     train_command = f"""python3.9 -m learning.train_ppo \
#     --root_dir={root_dir} \
...
#         collect_command = f"""CUDA_VISIBLE_DEVICES=-1 python3.9 -m learning.ppo_collect \
#         --root_dir={root_dir} \
#         --std_cell_placer_mode=dreamplace \
#         --replay_buffer_server_address={reverb_server} \
#         --variable_container_server_address={reverb_server} \
...
#     --init_placement={init_placement} \
#     --global_seed={global_seed} \
#     --output_placement_save_dir={root_dir}
#     """
